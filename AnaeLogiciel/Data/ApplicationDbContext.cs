...
public class ApplicationDbContext : IdentityDbContext
{
    ...
    public DbSet<AnaeLogiciel.Models.IndicateurActivite> IndicateurActivite { get; set; } = default!;
    
    public DbSet<AnaeLogiciel.Models.IndicateurSousActivite> IndicateurSousActivite { get; set; } = default!;
    ...
    public DbSet<AnaeLogiciel.Models.TargetTechnicienIndicateurSousActivite> TargetTechnicienIndicateurSousActivite { get; set; } = default!;
